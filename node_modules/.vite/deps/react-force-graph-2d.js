...
function $() {
  for (var n2, u2, t3, o2, r2, f2, c3, s2 = 1; i.length; ) i.length > s2 && i.sort(e), n2 = i.shift(), s2 = i.length, n2.__d && (t3 = void 0, o2 = void 0, r2 = (o2 = (u2 = n2).__v).__e, f2 = [], c3 = [], u2.__P && ((t3 = w({}, o2)).__v = o2.__v + 1, l.vnode && l.vnode(t3), O(u2.__P, t3, o2, u2.__n, u2.__P.namespaceURI, 32 & o2.__u ? [r2] : null, f2, null == r2 ? S(o2) : r2, !!(32 & o2.__u), c3), t3.__v = o2.__v, t3.__.__k[t3.__i] = t3, N(f2, t3, c3), o2.__e = o2.__ = null, t3.__e != r2 && C(t3)));
  $.__r = 0;
}
function I(n2, l2, u2, t3, i2, o2, r2, e2, f2, c3, s2) {
  var a3, h2, y3, d2, w2, g2, _2, m3 = t3 && t3.__k || v, b = l2.length;
  for (f2 = P(u2, l2, m3, f2, b), a3 = 0; a3 < b; a3++) null != (y3 = u2.__k[a3]) && (h2 = -1 == y3.__i ? p : m3[y3.__i] || p, y3.__i = a3, g2 = O(n2, y3, h2, i2, o2, r2, e2, f2, c3, s2), d2 = y3.__e, y3.ref && h2.ref != y3.ref && (h2.ref && B(h2.ref, null, y3), s2.push(y3.ref, y3.__c || d2, y3)), null == w2 && null != d2 && (w2 = d2), (_2 = !!(4 & y3.__u)) || h2.__k === y3.__k ? f2 = A(y3, f2, n2, _2) : "function" == typeof y3.type && void 0 !== g2 ? f2 = g2 : d2 && (f2 = d2.nextSibling), y3.__u &= -7);
  return u2.__e = w2, f2;
}
function P(n2, l2, u2, t3, i2) {
  var o2, r2, e2, f2, c3, s2 = u2.length, a3 = s2, h2 = 0;
  for (n2.__k = new Array(i2), o2 = 0; o2 < i2; o2++) null != (r2 = l2[o2]) && "boolean" != typeof r2 && "function" != typeof r2 ? ("string" == typeof r2 || "number" == typeof r2 || "bigint" == typeof r2 || r2.constructor == String ? r2 = n2.__k[o2] = m(null, r2, null, null, null) : d(r2) ? r2 = n2.__k[o2] = m(k, { children: r2 }, null, null, null) : void 0 === r2.constructor && r2.__b > 0 ? r2 = n2.__k[o2] = m(r2.type, r2.props, r2.key, r2.ref ? r2.ref : null, r2.__v) : n2.__k[o2] = r2, f2 = o2 + h2, r2.__ = n2, r2.__b = n2.__b + 1, e2 = null, -1 != (c3 = r2.__i = L(r2, u2, f2, a3)) && (a3--, (e2 = u2[c3]) && (e2.__u |= 2)), null == e2 || null == e2.__v ? (-1 == c3 && (i2 > s2 ? h2-- : i2 < s2 && h2++), "function" != typeof r2.type && (r2.__u |= 4)) : c3 != f2 && (c3 == f2 - 1 ? h2-- : c3 == f2 + 1 ? h2++ : (c3 > f2 ? h2-- : h2++, r2.__u |= 4))) : n2.__k[o2] = null;
...
function L(n2, l2, u2, t3) {
  var i2, o2, r2, e2 = n2.key, f2 = n2.type, c3 = l2[u2], s2 = null != c3 && 0 == (2 & c3.__u);
  if (null === c3 && null == e2 || s2 && e2 == c3.key && f2 == c3.type) return u2;
  if (t3 > (s2 ? 1 : 0)) {
    for (i2 = u2 - 1, o2 = u2 + 1; i2 >= 0 || o2 < l2.length; ) if (null != (c3 = l2[r2 = i2 >= 0 ? i2-- : o2++]) && 0 == (2 & c3.__u) && e2 == c3.key && f2 == c3.type) return r2;
  }
  return -1;
}
function T(n2, l2, u2) {
...
function O(n2, u2, t3, i2, o2, r2, e2, f2, c3, s2) {
  var a3, h2, p2, v2, y3, _2, m3, b, S2, C2, M2, $2, P2, A2, H, L2, T2, j2 = u2.type;
  if (void 0 !== u2.constructor) return null;
  128 & t3.__u && (c3 = !!(32 & t3.__u), r2 = [f2 = u2.__e = t3.__e]), (a3 = l.__b) && a3(u2);
  n: if ("function" == typeof j2) try {
    ...
    if (u2.__v = null, c3 || null != r2) if (n3.then) {
  ...
  else null == r2 && u2.__v == t3.__v ? (u2.__k = t3.__k, u2.__e = t3.__e) : f2 = u2.__e = q(t3.__e, u2, t3, i2, o2, r2, e2, c3, s2);
...
function q(u2, t3, i2, o2, r2, e2, f2, c3, s2) {
  ...
  if (null == u2) {
    ...
    u2 = document.createElementNS(r2, x3, k2.is && k2), c3 && (l.__m && l.__m(t3, e2), c3 = false), e2 = null;
  }
  if (null == x3) b === k2 || c3 && u2.data == k2 || (u2.data = k2);
    ...
    for (a3 in k2) w2 = k2[a3], "children" == a3 ? y3 = w2 : "dangerouslySetInnerHTML" == a3 ? h2 = w2 : "value" == a3 ? _2 = w2 : "checked" == a3 ? m3 = w2 : c3 && "function" != typeof w2 || b[a3] === w2 || j(u2, a3, w2, b[a3], r2);
    if (h2) c3 || v2 && (h2.__html == v2.__html || h2.__html == u2.innerHTML) || (u2.innerHTML = h2.__html), t3.__k = [];
    else if (v2 && (u2.innerHTML = ""), I("template" == t3.type ? u2.content : u2, d(y3) ? y3 : [y3], t3, i2, o2, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : r2, e2, f2, e2 ? e2[0] : i2.__k && S(i2, 0), c3, s2), null != e2) for (a3 = e2.length; a3--; ) g(e2[a3]);
    c3 || (a3 = "value", "progress" == x3 && null == _2 ? u2.removeAttribute("value") : null != _2 && (_2 !== u2[a3] || "progress" == x3 && !_2 || "option" == x3 && _2 != b[a3]) && j(u2, a3, _2, b[a3], r2), a3 = "checked", null != m3 && m3 != u2[a3] && j(u2, a3, m3, b[a3], r2));
  }
  return u2;
}
function B(n2, u2, t3) {
