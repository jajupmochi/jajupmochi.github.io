...
(function () {
  ...
  const I18N = {
    en: {
      ...
      'blog.nav_home': '← Home',
      'blog.nav_apps': 'Apps', 'blog.nav_personal': 'Personal',
      'blog.back': '← All posts',
    ...
    zh: {
      ...
      'blog.nav_home': '← 主页',
      'blog.nav_apps': '应用', 'blog.nav_personal': '个人',
      'blog.back': '← 所有文章',
      'blog.loading': '正在加载文章…',
    ...
    fr: {
      ...
      'blog.nav_apps': 'Applis', 'blog.nav_personal': 'Personnel',
    ...
    de: {
      ...
      'blog.nav_apps': 'Apps', 'blog.nav_personal': 'Persönlich',
